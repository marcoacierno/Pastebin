...
public class ErrorMessages {
  ...
  static {
    ...
    errors.put("Bad API request, maximum number of 25 unlisted pastes for your free account",
               R.string.maxunlimitedpastes);
    errors.put("Bad API request, maximum number of 10 private pastes for your free account",
