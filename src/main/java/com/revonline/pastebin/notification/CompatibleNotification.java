...
/**
 * Unica classe per gestire le notifiche su tutti i devices con tutti i livelli di API.
 *
 * @see CompatibleNotification#createNotification(android.content.Context) per creare una notifica
 * senza la necessità di eseguire nessun controllo sul livello API attuale
 */
